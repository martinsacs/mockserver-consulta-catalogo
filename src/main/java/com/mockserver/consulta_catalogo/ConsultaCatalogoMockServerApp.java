...
public class ConsultaCatalogoMockServerApp {

	private static WireMockServer wireMockServer;

	public static void main(String[] args) throws JsonProcessingException {
		SpringApplication.run(ConsultaCatalogoMockServerApp.class, args);
		startServer();
		Runtime.getRuntime().addShutdownHook(new Thread(ConsultaCatalogoMockServerApp::stopServer));
	}
